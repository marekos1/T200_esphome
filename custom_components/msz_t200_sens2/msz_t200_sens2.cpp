...
static const char *const TAG = "msz_t200_sens2";


static bool set_parent_was = false;

void MszT200Sens2::set_parent(msz_t200_device::MszT200Base *parent) { 
...
float MszT200Sens2::get_setup_priority() const { 
	return setup_priority::DATA; 
}
	
bool MszT200Sens2::read_data_(uint8_t *data) {
 /*ms
