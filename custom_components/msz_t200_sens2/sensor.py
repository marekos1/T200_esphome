...
msz_t200_sens2_ns = cg.esphome_ns.namespace("msz_t200_sens2")
MszT200Sens2 = msz_t200_sens2_ns.class_("MszT200Sens2", cg.PollingComponent)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(MszT200Sens2),
...
async def to_code(config):
    ...
    cg.add(var.set_bus(unit, module, bus))
